...
|day1 |  [1-1,结构化数据建模流程范例](./一、TensorFlow的建模流程/1-1 结构化数据建模流程范例.ipynb)    | ⭐️⭐️⭐️ |   1hour    |✅    |
|day2 |[1-2,图片数据建模流程范例](./一、TensorFlow的建模流程//1-2 图片数据建模流程范例.ipynb)    | ⭐️⭐️⭐️⭐️  |   2hour    |✅    |
|day3 |  [1-3,文本数据建模流程范例](./一、TensorFlow的建模流程//1-3 文本数据建模流程范例.ipynb)   | ⭐️⭐️⭐️⭐️⭐️  |   2hour    |✅    |
|day4 |  [1-4,时间序列数据建模流程范例](./一、TensorFlow的建模流程//1-4 时间序列数据建模流程范例.ipynb)   | ⭐️⭐️⭐️⭐️⭐️  |   2hour    |✅    |
|&nbsp;    |[**二、TensorFlow的核心概念**](./二、TensorFlow的核心概念.ipynb)  | ⭐️  |  0hour |✅  |
|day5 |  [2-1,张量数据结构](./二、TensorFlow的核心概念/2-1,张量数据结构.ipynb)  | ⭐️⭐️⭐️⭐️   |   1hour    |✅    |
|day6 |  [2-2,三种计算图](./二、TensorFlow的核心概念/2-2,三种计算图.ipynb)  | ⭐️⭐️⭐️⭐️⭐️   |   2hour    |✅    |
|day7 |  [2-3,自动微分机制](./二、TensorFlow的核心概念/2-3,自动微分机制.ipynb)  | ⭐️⭐️⭐️   |   1hour    |✅    |
|&nbsp; |[**三、TensorFlow的层次结构**](./三、TensorFlow的层次结构.md) |   ⭐️  |  0hour   |✅  |
|day8 |  [3-1,低阶API示范](./三、TensorFlow的层次结构/3-1,低阶API示范.ipynb)   | ⭐️⭐️   |   0.5hour    |✅   |
|day9 |  [3-2,中阶API示范](./三、TensorFlow的层次结构/3-2,中阶API示范.ipynb)   | ⭐️⭐️⭐️   |   0.5hour    |✅  |
|day10 |  [3-3,高阶API示范](./三、TensorFlow的层次结构/3-3,高阶API示范.ipynb)  | ⭐️⭐️⭐️   |   0.5hour    |✅  |
